...
translate([exterior_x/2,exterior_y/2,0]) cylinder(h = 4, r1 = 11, r2 = 11, $fn=100);
};
        
rotate(a = [0,-90,0]) difference(){
cube([exterior_x,exterior_y,2]);
translate([exterior_x/2,exterior_y/2-2,0]) cylinder(h = 2, r1 = rext, r2 = rext, $fn=100);
};
...
//translate([-distancia_cajas1+2,exterior_y/2,exterior_x/2]) rotate([0,90,0]) difference(){cylinder(h = distancia_cajas1, r1 = rexterior, r2 = rexterior, $fn=100);cylinder(h = distancia_cajas1, r1 = rinterior, r2 = rinterior, $fn=100);}
...
rotate(a = [90,0,0]) difference(){
cube([exterior_x,exterior_y,2]);
translate([exterior_x/2-2,exterior_y/2,0]) cylinder(h = 2, r1 = rext, r2 = rext, $fn=100);
};
...
rotate(a = [0,-90,0]) difference(){
cube([exterior_x,exterior_y,2]);
translate([exterior_x/2,exterior_y/2,0]) cylinder(h = 2, r1 = rext, r2 = rext, $fn=100);
};
...
translate([-exterior_x/2-distancia_cajas1+2,2-30,exterior_y/2]) rotate([90,0,0]) difference(){cylinder(h = distancia_cajas2-40, r1 = rexterior, r2 = rexterior, $fn=100);cylinder(h = distancia_cajas2, r1 = rinterior, r2 = rinterior, $fn=100);}

translate([0,-52,0]) difference(){     
translate([-91,-10-40,0]) cube([38,3,38]);
translate([-exterior_x/2-distancia_cajas1+2,2,exterior_y/2]) rotate([90,0,0]) cylinder(h = distancia_cajas1, r1 = rexterior, r2 = rexterior, $fn=100);
translate([-exterior_x/2-distancia_cajas1+2-17,2,exterior_y/2-15]) rotate([90,0,0]) cylinder(h = distancia_cajas1, r1 = rad, r2 = rad, $fn=100);
translate([-exterior_x/2-distancia_cajas1+2+15,2,exterior_y/2-15]) rotate([90,0,0]) cylinder(h = distancia_cajas1, r1 = rad, r2 = rad, $fn=100);
translate([-exterior_x/2-distancia_cajas1+2+15,2,exterior_y/2+15]) rotate([90,0,0]) cylinder(h = distancia_cajas1, r1 = rad, r2 = rad, $fn=100);
translate([-exterior_x/2-distancia_cajas1+2-17,2,exterior_y/2+15]) rotate([90,0,0]) cylinder(h = distancia_cajas1, r1 = rad, r2 = rad, $fn=100);
...
//ALTURA_CAMARA = 90;
//translate([0,-ALTURA_CAMARA,0]) translate([-exterior_x/2-distancia_cajas1+2,2-30,exterior_y/2]) rotate([90,0,0]) translate([0,0,distancia_cajas2-40]) difference(){cylinder(h = 40, r1 = rexterior, r2 = rexterior, $fn=100);cylinder(h = distancia_cajas2, r1 = rinterior, r2 = rinterior, $fn=100);}
//
...
//
//translate([-exterior_x/2-distancia_cajas1+2,2,exterior_y/2]) rotate([90,0,0]) cylinder(h = distancia_cajas1, r1 = rexterior, r2 = rexterior, $fn=100);
//translate([-exterior_x/2-distancia_cajas1+2-17,2,exterior_y/2-15]) rotate([90,0,0]) cylinder(h = 200, r1 = rad, r2 = rad, $fn=100);
//translate([-exterior_x/2-distancia_cajas1+2+15,2,exterior_y/2-15]) rotate([90,0,0]) cylinder(h = 200, r1 = rad, r2 = rad, $fn=100);
//translate([-exterior_x/2-distancia_cajas1+2+15,2,exterior_y/2+15]) rotate([90,0,0]) cylinder(h = 200, r1 = rad, r2 = rad, $fn=100);
//translate([-exterior_x/2-distancia_cajas1+2-17,2,exterior_y/2+15]) rotate([90,0,0]) cylinder(h = 200, r1 = rad, r2 = rad, $fn=100);
//
...
//        translate([exterior_x2/2,exterior_y2/2,ztotal]) cylinder(h = 2, r1 = rinterior, r2 = rinterior, $fn=100);};};
//
//ztotal2 = 10;
//dz = -2;
...
translate([-exterior_x/2-distancia_cajas1+2,2-30+5,exterior_y/2]) rotate([90,0,0]) cylinder(h = distancia_cajas2, r1 = rinterior, r2 = rinterior, $fn=100);
};
...
translate([4,0,0]) rotate(a = [90,0,0]) translate([exterior_x/2,exterior_y/2,-150]) cylinder(h = 100, r1 = 11, r2 = 11, $fn=100);
};
...
translate([-exterior_x/2-distancia_cajas1+2,2,exterior_y/2]) rotate([90,0,0]) difference(){cylinder(h = distancia_cajas1, r1 = rexterior, r2 = rexterior, $fn=100);cylinder(h = distancia_cajas1, r1 = 0, r2 = 0, $fn=100);}
};



//difference(){ translate([-55,-75,0]) cube([4,10,38]);;
//translate([-exterior_x/2-distancia_cajas1+2,2,exterior_y/2]) rotate([90,0,0]) difference(){cylinder(h = distancia_cajas1, r1 = rexterior, r2 = rexterior, $fn=100);cylinder(h = distancia_cajas1, r1 = rinterior, r2 = rinterior, $fn=100);}
//};
